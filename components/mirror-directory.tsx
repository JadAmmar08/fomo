...
// The only thing this room-facing "memory" surface shows: your own private file
// and a way to talk to it. No insight tiles, no team-wide synthesis, just AI
// memory and ways it can help, per Jad's explicit call to cut the directory
// concept down to this.
